...
Similarly we can find the area for all others shapes using the same format by passing the object of a particular shape created. 
...
![](Customised Cylinder.png){width=600px height=300px}
